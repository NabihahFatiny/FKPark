<?php
/**
 * Run this once after dropping the fkpark database to recreate it and all tables.
 * Open in browser: http://localhost/FKPark/DB_FKPark/setup_db.php
 */
...
// Create tables (same order as createTable.php)
$tables = [
...
mysqli_close($con);
echo "<p><strong>Setup complete.</strong> You can now use the site. <a href='../Index/'>Go to FKPark</a></p>";
?>
